...
# -*- coding: utf-8 -*-
"""
A more recent implementation of AWS S3 support with parse_path function corrected.
added AWS region_name in luigi.cfg.
"""
...
def parse_s3_path(path):
    "For a given S3 path, return the bucket and key values. attribute netloc comes as <bucket_name>.s3.amazon.com"
    import pdb
    pdb.set_trace()
    parsed_path = urlsplit(path)
    s3_bucket = parsed_path.netloc.split('.')[0]
